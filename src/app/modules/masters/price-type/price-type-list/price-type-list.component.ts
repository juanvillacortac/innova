...
export class PriceTypeListComponent implements OnInit {
    ...
    [
     ...
     {template: (data) => { return data.pricesGrouping.name; }, field: 'pricesGrouping', header: 'Agrupación de precio', display: 'table-cell'},
     {template: (data) => { return data.country.name; }, field: 'country', header: 'País', display: 'table-cell'},   
    ...
    constructor(
        ...
        private breadcrumbService: BreadcrumbService) { 
          this.breadcrumbService.setItems([
            ...
            { label: 'Tipo de precio', routerLink: ['/pricetype-list'] }
        ]); 
      }
