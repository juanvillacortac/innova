...
export class BranchofficesListComponent implements OnInit {
  ...
  displayedColumns: ColumnD<Branchoffice>[] =
    [
      ...
      { template: (data) => { return data.countryName; }, header: 'País', display: 'table-cell', field:'countryName'  },            
      ...
      { template: (data) => { return data.updatedByUser; }, header: 'Actualizado por', display: 'table-cell',field: 'updateByUser' }
    ];
