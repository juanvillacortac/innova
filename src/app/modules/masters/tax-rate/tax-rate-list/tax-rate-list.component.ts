...
export class TaxRateListComponent implements OnInit {
    ...
    [
     ...
     {template: (data) => { return data.tax.name; }, field: 'tax', header: 'Impuesto', display: 'table-cell'},
     {template: (data) => { return data.value; }, field: 'value', header: 'Valor', display: 'table-cell'},
     {template: (data) => { return data.rateType.name; }, field: 'rateType', header: 'Tipo de tasa', display: 'table-cell'},
    ...
    constructor(
        ...
        private breadcrumbService: BreadcrumbService) { 
          this.breadcrumbService.setItems([
            ...
            { label: 'Tasa de impuesto', routerLink: ['/taxrate-list'] }
        ]); 
      }
