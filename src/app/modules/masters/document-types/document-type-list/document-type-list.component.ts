...
export class DocumentTypeListComponent implements OnInit {
  ...
  [
   ...
   {template: (data) => { return data.entityType.name; }, field: 'entityType', header: 'Clasificación', display: 'table-cell'},
  ...
  constructor(
      ...
      private breadcrumbService: BreadcrumbService) { 
        this.breadcrumbService.setItems([
          ...
          { label: 'Tipo de documento', routerLink: ['/document-type-list'] }
      ]); 
    }
