...
export class MotiveListComponent implements OnInit {
  ...
  [
   ...
   {template: (data) => { return data.motiveType.name; },field: 'motiveType', header: 'Tipo motivo', display: 'table-cell'},
   {template: (data) => { return data.motiveType.module; },field: 'module', header: 'Modulo', display: 'table-cell'},
