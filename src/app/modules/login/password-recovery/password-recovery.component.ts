...
export class PasswordRecoveryComponent implements OnInit {
  ...
  private generateOtpCode(otpCode) {
    this._authService.generateOtpCode(otpCode).subscribe((res) => {
      ...
      this.messageService.add({severity:'success',life:5000, summary:'Código de recuperación', detail: "El código de recuperación ha sido enviado a su correo electrónico"});
  ...
  {
    let result = Boolean(value ==='true' ? true: false);
    return result;
  }
