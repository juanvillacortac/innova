...
export class AttributeagrupationListComponent implements OnInit {
  ...
  constructor(public _attributeagrupationservice: AttributeagrupationService,
    ...
    this.breadcrumbService.setItems([
      { label: 'OSM' },
      { label: 'MPC' },
      { label: 'Agrupación de atributos', routerLink: ['/attributeagrupation-list'] }
    ]);
   }
  ...
  search(){
    ...
    this.loading = false;
    this._attributeagrupationservice.getAttributesAgrupationbyfilter(this.attributeagrupationFilters).subscribe((data: Attributeagrupation[]) => {
  ...
  onEdit(id: number) {
    ...
    this._attributeagrupationservice.getAttributesAgrupationbyfilter(this.attributeagrupationId).subscribe((data: Attributeagrupation[]) => {
