...
export class MenuComponent implements OnInit {
  ...
  onLoadItemMenu(){
    this.items = [
      ...
      {label: 'Asociados', icon: 'pi pi-fw pi-clone',disabled: this.idproduct == 0 ? true : this._product.statusId == StatusProduct.Eraser || this._product.statusId == StatusProduct.Canceled ? true : false,command: (event) => {
      ...
      {label: 'Especificaciones', icon: 'pi pi-fw pi-table',disabled: this.idproduct == 0 ? true : this._product.statusId == StatusProduct.Eraser || this._product.statusId == StatusProduct.Canceled ? true : false,command: (event) => {
